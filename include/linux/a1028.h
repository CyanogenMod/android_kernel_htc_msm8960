...
enum A1028_NS_states {
	A1028_NS_STATE_AUTO,	/* leave mode as selected by driver  */
	A1028_NS_STATE_OFF,	/* disable noise suppression */
	A1028_NS_STATE_CT,	/* force close talk mode */
	A1028_NS_STATE_FT,	/* force far talk mode */
	A1028_NS_NUM_STATES
};

/* indicates if a1028_set_config() performs a full configuration or only
 * a voice processing algorithm configuration */
/* IOCTLs for Audience A1028 */
