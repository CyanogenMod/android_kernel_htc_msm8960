...
static struct msm_gpiomux_config jet_gsbi_configs[] __initdata = {
	{
		.gpio      = JET_TP_I2C_SDA,	/* GSBI3 I2C QUP SDA */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi3,
		},
	},
	{
		.gpio      = JET_TP_I2C_SCL,	/* GSBI3 I2C QUP SCL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi3,
		},
	},
#if 0
	{
		.gpio      = JET_CAM_I2C_SDA,	/* GSBI4 I2C QUP SDA */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi4,
		},
	},
	{
		.gpio      = JET_CAM_I2C_SCL,	/* GSBI4 I2C QUP SCL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi4,
		},
	},
	{
		/* GSBI10 SPI QUP JET_MCAM_SPI_CLK */
		.gpio      = JET_MCAM_SPI_CLK,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi10,
		},
	},
	{
		/* GSBI10 SPI QUP JET_MCAM_SPI_CS0 */
		.gpio      = JET_MCAM_SPI_CS0,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi10,
		},
	},
	{
		/* GSBI10 SPI QUP JET_MCAM_SPI_DI */
		.gpio      = JET_MCAM_SPI_DI,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi10,
		},
	},
	{
		/* GSBI10 SPI QUP JET_MCAM_SPI_DO */
		.gpio      = JET_MCAM_SPI_DO,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi10,
		},
	},
#endif
	{
		.gpio	   = JET_AC_I2C_SDA,	/* GSBI8 I2C QUP SDA */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi8,
		},
	},
	{
		.gpio	   = JET_AC_I2C_SCL,	/* GSBI8 I2C QUP SCL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi8,
		},
	},
	{
		.gpio      = JET_SENSOR_I2C_SDA,	/* GSBI12 I2C QUP SDA */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi12,
		},
	},
	{
		.gpio      = JET_SENSOR_I2C_SCL,	/* GSBI12 I2C QUP SCL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gsbi12,
		},
	},
...
static struct msm_gpiomux_config jet_slimbus_configs[] __initdata = {
	{
		.gpio	= JET_AUD_WCD_SB_CLK,		/* slimbus data */
		.settings = {
			[GPIOMUX_SUSPENDED] = &slimbus,
		},
	},
	{
		.gpio	= JET_AUD_WCD_SB_DATA,		/* slimbus clk */
		.settings = {
			[GPIOMUX_SUSPENDED] = &slimbus,
		},
	},
...
static struct msm_gpiomux_config jet_cam_configs[] = {
	{
		.gpio = JET_CAM_MCLK1,
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[4], /*A FUNC1 8MA*/
...
static struct msm_gpiomux_config jet_mdp_vsync_configs[] __initdata = {
	{
		.gpio = JET_LCD_TE,
		.settings = {
...
static struct gpiomux_setting haptic_ldo_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH,
...
static struct gpiomux_setting haptic_ldo_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct msm_gpiomux_config pm8xxxx_haptic_configs[] __initdata = {
	...
	{	/* LDO VDD */
		.gpio = JET_V_HAPTIC_3V3_EN,
		.settings = {
			[GPIOMUX_ACTIVE]    = &haptic_ldo_act_cfg,
			[GPIOMUX_SUSPENDED] = &haptic_ldo_sus_cfg,
		},
	},
};
#endif
...
int __init jet_gpiomux_init(void)
{
	...
	msm_gpiomux_install(jet_mdp_vsync_configs,
			ARRAY_SIZE(jet_mdp_vsync_configs));
