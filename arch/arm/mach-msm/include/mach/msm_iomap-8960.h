...
#define MSM8960_RPM_SIZE		SZ_24K
...
#define MSM_DEBUG_UART_PHYS		0x1A040000      /*GSBI8*/
#endif
...
#define MSM_GPU_SNAP_SHOT_3D0_PHYS	0x88800000
#define MSM_GPU_SNAP_SHOT_3D0_SIZE	SZ_512K /* 512K for gpu snapshot */

#define MSM_GPU_SNAP_SHOT_2D1_PHYS	(MSM_GPU_SNAP_SHOT_3D0_PHYS + MSM_GPU_SNAP_SHOT_3D0_SIZE) /*0x88880000*/
#define MSM_GPU_SNAP_SHOT_2D1_SIZE	SZ_512K /* 512K for c2d snapshot */

#define MSM_HTC_RAM_CONSOLE_PHYS	(MSM_GPU_SNAP_SHOT_2D1_PHYS + MSM_GPU_SNAP_SHOT_2D1_SIZE) /*0x88900000*/
...
/* MSM_HTC_DEBUG_INFO_PHYS --- BEGIN */
#define MSM_TZLOG_PHYS			MSM_HTC_DEBUG_INFO_PHYS /*0x889E0000*/
#define MSM_TZLOG_SIZE			SZ_64K

#define MSM_TZ_DOG_BARK_REG_SAVE_PHYS	(MSM_HTC_DEBUG_INFO_PHYS + MSM_TZLOG_SIZE) /*0x889F0000*/
#define MSM_TZ_DOG_BARK_REG_SAVE_SIZE	SZ_4K

#define MSM_KERNEL_FOOTPRINT_PHYS	(MSM_TZ_DOG_BARK_REG_SAVE_PHYS + MSM_TZ_DOG_BARK_REG_SAVE_SIZE) /*0x889F1000*/
#define MSM_KERNEL_FOOTPRINT_SIZE		SZ_4K

#define MSM_KALLSYMS_SAVE_PHYS	(MSM_KERNEL_FOOTPRINT_PHYS + MSM_KERNEL_FOOTPRINT_SIZE) /* 0x889F2000 */
#define MSM_KALLSYMS_SAVE_SIZE	(SZ_64K - MSM_TZ_DOG_BARK_REG_SAVE_SIZE - MSM_KERNEL_FOOTPRINT_SIZE) /*56K*/

/* MSM_HTC_DEBUG_INFO_PHYS --- END */
