...
static int ville_mt9v113_vreg_on(void)
{
	...
	/* IO */
	rc = gpio_request(VILLE_GPIO_V_LCMIO_1V8_EN, "CAM_D1V8_EN");
	pr_err("[CAM] ville_mt9v113_vreg_on %d 1v8\n", VILLE_GPIO_V_LCMIO_1V8_EN);
	if (rc < 0) {
		pr_err("[CAM] %s:GPIO_CAM_D1V8_EN gpio %d request failed, rc=%d\n", __func__,  VILLE_GPIO_V_LCMIO_1V8_EN, rc);
		goto init_fail;
	}
...
static int ville_mt9v113_vreg_off(void)
{
	...
	/* IO */
	rc = gpio_request(VILLE_GPIO_V_LCMIO_1V8_EN, "CAM_D1V8_EN");
	pr_err("[CAM] ville_mt9v113_vreg_off %d 1v8\n", VILLE_GPIO_V_LCMIO_1V8_EN);
	if (rc < 0) {
		pr_err("[CAM] %s:GPIO_CAM_D1V8_EN gpio %d request failed, rc=%d\n", __func__,  VILLE_GPIO_V_LCMIO_1V8_EN, rc);
		goto init_fail;
	}
...
static struct pc_temp_ocv_lut pc_temp_ocv_id_1 = {
	...
	.percent	= {100, 95, 90, 85, 80, 75, 70, 65, 60, 55,
				...
				8, 7, 6, 5, 4, 3, 2, 1, 0},
	.ocv		= {
				{4157, 4156, 4153, 4149, 4142},
				{4104, 4120, 4124, 4123, 4118},
				{4041, 4072, 4079, 4078, 4074},
				{3985, 4027, 4038, 4037, 4033},
				{3939, 3985, 4001, 4000, 3995},
				{3899, 3946, 3966, 3965, 3960},
				{3869, 3911, 3936, 3935, 3930},
				{3845, 3879, 3907, 3908, 3903},
				{3825, 3852, 3871, 3874, 3872},
				{3809, 3827, 3836, 3838, 3838},
				{3792, 3808, 3815, 3814, 3813},
				{3776, 3792, 3798, 3798, 3797},
				{3762, 3778, 3785, 3784, 3784},
				{3747, 3764, 3776, 3774, 3772},
				{3730, 3748, 3768, 3765, 3755},
				{3713, 3732, 3757, 3752, 3735},
				{3692, 3720, 3735, 3729, 3713},
				{3666, 3704, 3697, 3691, 3677},
				{3646, 3691, 3684, 3679, 3666},
				{3640, 3688, 3682, 3678, 3665},
				{3632, 3684, 3680, 3676, 3663},
				{3624, 3680, 3678, 3674, 3661},
				{3615, 3673, 3674, 3669, 3655},
				{3602, 3661, 3662, 3656, 3639},
				{3586, 3642, 3638, 3630, 3614},
				{3564, 3613, 3605, 3597, 3581},
				{3534, 3571, 3560, 3554, 3540},
				{3486, 3509, 3500, 3497, 3484},
...
static void __init register_i2c_devices(void)
{
	...
	u8 mach_mask = 0;
	int i;
	struct cm3629_platform_data *cm3629_pdata = NULL;
