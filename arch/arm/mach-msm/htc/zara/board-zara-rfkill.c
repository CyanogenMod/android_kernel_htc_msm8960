...
static void __exit zara_rfkill_exit(void)
{
	platform_driver_unregister(&zara_rfkill_driver);
}

module_init(zara_rfkill_init);
module_exit(zara_rfkill_exit);
MODULE_DESCRIPTION("zara rfkill");
