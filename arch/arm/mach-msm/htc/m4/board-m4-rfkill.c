...
static struct rfkill_ops m4_rfkill_ops = {
...
static int m4_rfkill_remove(struct platform_device *dev)
{
...
static struct platform_driver m4_rfkill_driver = {
	.probe = m4_rfkill_probe,
	.remove = m4_rfkill_remove,
	.driver = {
		.name = "m4_rfkill",
		.owner = THIS_MODULE,
	},
...
static int __init m4_rfkill_init(void)
{
